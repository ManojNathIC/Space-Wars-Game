...
engine=pyttsx3.init()
engine.say("Hello Welcome to Space Wars game ")

engine.say(" Game will about to start, Be raedy ! Have a fun  ")
engine.runAndWait()
...
# Title and Icon
pygame.display.set_caption("Inspriom")
icon = pygame.image.load("inspriom.png")
